...
public class ModVillargers {
    ...
    public static final RegistryObject<VillagerProfession> FIGHT_MASTER = PROFESSIONS.register("fight_master",
            () -> new VillagerProfession( "Fight Master", x -> x.get() == SWORD_SUPPORT_POI.get(),
