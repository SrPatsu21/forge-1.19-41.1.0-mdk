...
public class MagicLaserEntity extends AbstractUranusModProjectile
{
    ...
    public MagicLaserEntity(EntityType<? extends MagicSphereEntity> entityEntityType, Level level, double x , double y, double z)
    {
        this(entityEntityType, level);
        this.setPos(x, y, z);
    }
    public MagicLaserEntity(EntityType<? extends MagicSphereEntity> entityEntityType, Level level, LivingEntity entity,
...
//        }
    ...
    protected void onHitBlock(BlockHitResult hitResult)
    {
        ...
        if (this.getOwner() != null && this.getSkillAttributes() != null)
        {
            reaction.reactionOnBlock(hitResult.getBlockPos());
        }
    }
//    @Override
